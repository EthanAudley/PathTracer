...
{
	Vector3 vp0 = point - m_vertices[0].m_position;
	Vector3 v10 = m_vertices[1].m_position - m_vertices[0].m_position;

	Vector3 vp1 = point - m_vertices[1].m_position;
	Vector3 v21= m_vertices[2].m_position - m_vertices[1].m_position;

	Vector3 vp2 = point - m_vertices[2].m_position;
	Vector3 v20 = m_vertices[0].m_position - m_vertices[2].m_position;

	Vector3 v02 = m_vertices[2].m_position - m_vertices[0].m_position;

	double a012 = v10.CrossProduct(v02).Norm();
	double a0p1 = v10.CrossProduct(vp0).Norm();
	double a1p2 = v21.CrossProduct(vp1).Norm();
	double a2p0 = v20.CrossProduct(vp2).Norm();

	a012 = 1.0 / a012;

	return Vector3(a1p2*a012, a2p0*a012, a0p1*a012);
}
